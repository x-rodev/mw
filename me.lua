...
local Library do 
    ...
    local Instances = { } do
        ...
        Instances.MakeDraggable = function(self)
            ...
            local function IsInteractiveElement(obj)
                -- Check if the object is an interactive UI element
                if obj:IsA("TextButton") or obj:IsA("TextBox") or obj:IsA("ImageButton") then
                    return true
                end
                
                -- Check for specific class names that indicate sliders, colorpickers, etc.
                local parent = obj.Parent
                while parent do
                    if parent.Name == "RealSlider" or parent.Name == "Circle" or parent.Name == "Accent" 
                        or parent.Name == "Palette" or parent.Name == "Hue" 
                        or parent.Name == "RealDropdown" or parent.Name == "Input" then
                        return true
                    end
    ...
    do
        ...
        Library.CreateKeybind = function(self, Data)
            ...
            Items["KeyButton"]:Connect("InputBegan", function(Input)
                if Input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    local InputBegan2
                    InputBegan2 = UserInputService.InputBegan:Connect(function(Input2)
                        if Input2.UserInputType == Enum.UserInputType.Keyboard then 
                            Keybind:Set(Input2.KeyCode)
                        else
                            Keybind:Set(Input2.UserInputType)
                        end

                        InputBegan2:Disconnect()
                        InputBegan2 = nil
                    end)
                end
            end)
            ...
            Items["KeyButton"]:Connect("InputEnded", function(Input)
                if Input.UserInputType == Enum.UserInputType.Touch then
                    -- Check if it was a long press (held for more than 0.5 seconds)
                    local holdTime = tick() - (Input.UserInputState == Enum.UserInputState.Begin and tick() or 0)
        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                ...
                -- Adjust size for mobile to fit phone screens but still be usable
                local WindowWidth = IsMobile and 500 or 798
                local WindowHeight = IsMobile and 400 or 599
                ...
                Items["MainFrame"] = Instances:Create("Frame", {
                    ...
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(0, WindowWidth, 0, WindowHeight),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(16, 18, 18)
                ...
                Items["Side"] = Instances:Create("Frame", {
                    ...
                    BackgroundTransparency = 1,
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(0, IsMobile and 150 or 215, 1, 0),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })
                ...
                Items["Title"] = Instances:Create("Frame", {
                    ...
                    Name = "\0",
                    Position = UDim2New(0, IsMobile and 4 or 6, 0, IsMobile and 4 or 6),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(1, IsMobile and -8 or -12, 0, IsMobile and 55 or 60),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(21, 24, 24)
                ...
                Items["Game"] = Instances:Create("TextLabel", {
                    ...
                    BorderSizePixel = 0,
                    BackgroundTransparency = 1,
                    Position = UDim2New(0, IsMobile and 48 or 58, 0, IsMobile and 30 or 30),
                    BorderColor3 = FromRGB(0, 0, 0),
                    AutomaticSize = Enum.AutomaticSize.X,
                ...
                Instances:Create("UICorner", {
                    Parent = Items["MinimizeBtn"].Instance,
                    Name = "\0",
                    CornerRadius = UDimNew(1, 0)
                })
                ...
                Instances:Create("UICorner", {
                    Parent = Items["CloseBtn"].Instance,
                    Name = "\0",
                    CornerRadius = UDimNew(1, 0)
                })
                ...
                Items["Content"] = Instances:Create("Frame", {
                    Parent = Items["MainFrame"].Instance,
                    Name = "\0",
                    Position = UDim2New(0, IsMobile and 155 or 220, 0, IsMobile and 4 or 6),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(1, IsMobile and -159 or -226, 1, IsMobile and -8 or -12),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(21, 24, 24)
                ...
                Items["Bottom_"] = Instances:Create("Frame", {
                    ...
                    Name = "\0",
                    AnchorPoint = Vector2New(0, 1),
                    Position = UDim2New(0, IsMobile and 4 or 6, 1, IsMobile and -4 or -6),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(1, IsMobile and -8 or -12, 0, IsMobile and 42 or 45),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(21, 24, 24)
                ...
                -- Profile Image
                Items["ProfileImage"] = Instances:Create("ImageLabel", {
                    Parent = Items["Bottom_"].Instance,
                    Name = "\0",
                    BorderColor3 = FromRGB(0, 0, 0),
                    AnchorPoint = Vector2New(0, 0.5),
                    ...
                    BackgroundTransparency = 1,
                    Position = UDim2New(0, IsMobile and 5 or 8, 0.5, 0),
                    Size = UDim2New(0, IsMobile and 32 or 35, 0, IsMobile and 32 or 35),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })
                
                Instances:Create("UICorner", {
                    Parent = Items["ProfileImage"].Instance,
                    Name = "\0",
                    CornerRadius = UDimNew(1, 0)
                })
                ...
                Items["Username"] = Instances:Create("TextLabel", {
                    ...
                    Size = UDim2New(1, IsMobile and -42 or -50, 0, IsMobile and 12 or 13),
                    BackgroundTransparency = 1,
                    Position = UDim2New(0, IsMobile and 42 or 48, 0, IsMobile and 7 or 8),
                    BorderSizePixel = 0,
                ...
                Items["DisplayName"] = Instances:Create("TextLabel", {
                    ...
                    Size = UDim2New(1, IsMobile and -42 or -50, 0, IsMobile and 11 or 12),
                    BackgroundTransparency = 1,
                    Position = UDim2New(0, IsMobile and 42 or 48, 0, IsMobile and 23 or 24),
                    BorderSizePixel = 0,
            ...
            function Window:SetOpen(Bool)
                ...
                if IsMobile and Items["MobileToggle"] then
                    Items["MobileToggle"].Instance.Text = Bool and "✕" or "☰"
                end
        ...
        Library.Page = function(self, Data)
            ...
            local Items = { } do
                Items["Inactive"] = Instances:Create("TextButton", {
                    ...
                    AutoButtonColor = false,
                    BackgroundTransparency = 1,
                    Size = UDim2New(0, IsMobile and 165 or 200, 0, IsMobile and 28 or 30),
                    BorderSizePixel = 0,
                    TextSize = IsMobile and 12 or 14,
                    BackgroundColor3 = FromRGB(21, 24, 24)
                ...
                Items["Icon"] = Instances:Create("ImageLabel", {
                    ...
                    Size = UDim2New(0, IsMobile and 14 or 16, 0, IsMobile and 14 or 16),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })
                ...
                Items["Text"] = Instances:Create("TextLabel", {
                    ...
                    Size = UDim2New(0, 0, 0, 15),
                    BackgroundTransparency = 1,
                    Position = UDim2New(0, IsMobile and 32 or 38, 0.5, 0),
                    BorderSizePixel = 0,
                    AutomaticSize = Enum.AutomaticSize.X,
                    TextSize = IsMobile and 12 or 14,
                    BackgroundColor3 = FromRGB(255, 255, 255)
        ...
        Library.Sections.Dropdown = function(self, Data)
            ...
            local Items = { } do 
                ...
                -- Up Arrow
                Items["UpArrow"] = Instances:Create("TextLabel", {
                    Parent = Items["RealDropdown"].Instance,
                    Name = "\0",
                    FontFace = Library.Font,
                    TextColor3 = FromRGB(150, 150, 150),
                ...
                -- Down Arrow
                Items["DownArrow"] = Instances:Create("TextLabel", {
                    Parent = Items["RealDropdown"].Instance,
                    Name = "\0",
                    FontFace = Library.Font,
                    TextColor3 = FromRGB(150, 150, 150),
            ...
            function Dropdown:SetOpen(Bool)
                ...
                if Dropdown.IsOpen then 
                    ...
                    RenderStepped = RunService.RenderStepped:Connect(function()
                        Items["OptionHolder"].Instance.Position = UDim2New(0, Items["RealDropdown"].Instance.AbsolutePosition.X, 0, Items["RealDropdown"].Instance.AbsolutePosition.Y + Items["RealDropdown"].Instance.AbsoluteSize.Y + 2)
    ...
    Library.CreateSettingsPage = function(self, Window)
        local SettingsPage = Window:Page({Name = "Settings", Icon = "72732892493295"}) do 
            ...
            do -- Theming
                local ThemingSection = SettingsPage:Section({Name = "Theming", Icon = "131595494666590", Side = 1})
            ...
            do -- Settings
                local SettingsSection = SettingsPage:Section({Name = "Settings", Icon = "72732892493295", Side = 2})     
