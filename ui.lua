...
-- Variables 
    ...
    local device_type = is_mobile and "Mobile" or "PC"
    ...
    -- Library element functions
            ...
            function cfg.open_tab() 
                ...
                if selected_tab then 
                    if selected_tab[ 4 ] ~= items[ "tab_holder" ] then 
                        ...
                        selected_tab[ 4 ].Size = dim2(1, -216, 1, -25)
                    end
                ...
                library:tween(items[ "tab_holder" ], {Size = dim2(1, -196, 1, -25)}, Enum.EasingStyle.Quad, 0.4)
        ...
        function library:colorpicker(options) 
            ...
            function cfg.update_color(input_position) 
                local offset = input_position or vec2(uis:GetMouseLocation().X, uis:GetMouseLocation().Y - gui_offset)
        ...
        function library:init_config(window) 
            ...
            if not is_mobile then
                section:keybind({name = "Menu Bind", callback = function(bool) window.toggle_menu(bool) end, default = true, key = Enum.KeyCode.RightShift})
            end
        end
    --
